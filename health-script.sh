#!/bin/bash
# This is v1.0.0 of VDP Health Script
# This Script performs service checks, appliance status checks, maintenance checks
# Along with client info, storage info, vCenter connection test.
# This script calls a second script to send the output to an email
# For bugs and Feature Requests email gsuhas@vmware.com
# This script is tested on 6.0.x and 6.1.x
